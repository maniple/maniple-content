 ...
 * @method ManiplePages_Model_PageVersion|null fetchRow(mixed $where = null, string|array $order = null, int $offset = null)
 ...
 * @method Zend_Db_Table_Rowset_Abstract|ManiplePages_Model_PageVersion[] fetchAll(mixed $where = null, string|array $order = null, int $count = null, int $offset = null)
 */
